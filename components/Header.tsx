...
const Header = async () => {
  ...
  return (
    <header className={`bg-background-light text-text-light dark:bg-background-dark dark:text-text-dark border-b border-solid border-primary-light dark:border-primary-dark top-0 z-50 h-fit lg:h-screen w-full lg:w-[25%] lg:border-b-0 lg:border-r lg:border-solid lg:border-primary-light dark:lg:border-primary-dark fixed ${session?.user ? 'min-h-[135px]' : 'min-h-[80px]'}`}>
