  ...
  return (
    <ErrorBoundary>
      <main className="bg-custom flex flex-col items-center absolute top-0 left-0 w-full lg:left-[25%] lg:w-[75%] px-8 py-16 mt-[118px] h-fit lg:mt-0 lg:h-auto">
        <div className='flex flex-col gap-8 bg-background-light dark:bg-background-dark p-8 lg:p-24 border border-solid border-primary-light dark:border-primary-dark w-full lg:mt-0 text-text-light dark:text-text-dark'>
          <div className="flex items-baseline flex-wrap gap-2 break-all">
